...
st.markdown(f"""
    <nav class="navbar-custom">
        <a onclick="window.location.href='/?page=home' class="nav-item">Home</a>
        <a onclick="window.location.href='/?page=dashboard' class="nav-item">Dashboard</a>
        <a onclick="window.location.href='/?page=modelos' class="nav-item">Modelos</a>
    </nav>
""", unsafe_allow_html=True)
